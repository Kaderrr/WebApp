...
@UserReceptionist
@Provider
public class UserServiceProviderFilter implements ContainerRequestFilter {
    ...
    public boolean isUserReceptionist() {
        ...
        return Constants.USER_PERMISSION_LEVEL_SERVICE_PROVIDER.equals(userPermissionLevel) ||
                Constants.USER_PERMISSION_LEVEL_RECEPTIONIST.equals(userPermissionLevel) ||
